...
def get_coco_categories_with_prompt_eng():
    ...
    coco_id_names = open('/home/couaironp/zero-shot_segmentation/ODISE_diffusers/patch-aligned/data/metadata/datasets/coco_panoptic_with_prompt_eng.txt').read().splitlines()
    coco_idx = 0
...
def get_coco_stuff_categories_with_prompt_eng():
    ...
    coco_id_names = open('/home/couaironp/zero-shot_segmentation/ODISE_diffusers/patch-aligned/data/metadata/datasets/coco_stuff_with_prompt_eng.txt').read().splitlines()
    coco_idx = 0
    for line in coco_id_names:
        idx, name = line.split(':')
        idx = int(idx)
...
def get_ade20k_categories_with_prompt_eng():
    ...
    ade20k_id_names = open('/home/couaironp/zero-shot_segmentation/ODISE_diffusers/patch-aligned/data/metadata/datasets/ade20k_150_with_prompt_eng.txt').read().splitlines()
    ade_idx = 0
...
def get_cityscapes_categories_with_prompt_eng():
    ...
    cityscapes_id_names = open('/home/couaironp/zero-shot_segmentation/ODISE_diffusers/patch-aligned/data/metadata/datasets/cityscapes_with_prompt_eng.txt').read().splitlines()
    cityscapes_idx = 0
...
def get_ade20k_847_categories_with_prompt_eng():
    ...
    ade20k_847_id_names = open('/home/couaironp/zero-shot_segmentation/ODISE_diffusers/patch-aligned/data/metadata/datasets/ade20k_847_with_prompt_eng.txt').read().splitlines()
    ade_idx = 0
...
def get_pascal_21_categories_with_prompt_eng():
    ...
    pascal_21_id_names = open('/home/couaironp/zero-shot_segmentation/ODISE_diffusers/patch-aligned/data/metadata/datasets/pascal_voc_21_with_prompt_eng.txt').read().splitlines()
    pas_idx = 0
...
def get_pascal_ctx_459_categories_with_prompt_eng():
    ...
    pascal_ctx_459_id_names = open('/home/couaironp/zero-shot_segmentation/ODISE_diffusers/patch-aligned/data/metadata/datasets/pascal_ctx_459_with_prompt_eng.txt').read().splitlines()
    pas_idx = 0
...
def get_pascal_ctx_59_categories_with_prompt_eng():
    ...
    pascal_ctx_59_id_names = open('/home/couaironp/zero-shot_segmentation/ODISE_diffusers/patch-aligned/data/metadata/datasets/pascal_ctx_59_with_prompt_eng.txt').read().splitlines()
    pas_idx = 0
...
def get_mapillary_vistas_categories_with_prompt_eng():
    ...
    mapillary_vistas_id_names = open('/home/couaironp/zero-shot_segmentation/ODISE_diffusers/patch-aligned/data/metadata/datasets/mapillary_vistas_with_prompt_eng.txt').read().splitlines()
    mapillary_idx = 0
