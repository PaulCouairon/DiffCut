...
class Benchmark_Segmentation:
    def __init__(self,
        ...
        subfolder_path = f'{encode_method}_{steps[0]}'
...
def parse_args():
    ...
    parser.add_argument("--inverse_scheduler", type=str, default=None, choices=[None, 'inv_ddim'], help="Inverse scheduler of the diffusion model")
    ...
    parser.add_argument("--alpha", type=int, default=10, help="Exponent value")
...
if __name__ == "__main__":
    ...
    sem_seg = Benchmark_Segmentation(model_name=args.model_name, dataset_name=args.dataset_name,
                                     steps=(args.steps,), n_steps=args.n_steps, encode_method=args.encode_method,
                                     img_size=args.img_size, refinement=args.refinement, alpha=args.alpha)
